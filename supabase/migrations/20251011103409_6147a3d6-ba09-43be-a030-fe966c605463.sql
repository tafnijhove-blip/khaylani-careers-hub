...
DROP POLICY IF EXISTS users_view_linked_vacatures ON public.vacatures;
DROP POLICY IF EXISTS ceo_am_insert_linked_vacatures ON public.vacatures;
DROP POLICY IF EXISTS ceo_am_update_linked_vacatures ON public.vacatures;
DROP POLICY IF EXISTS ceo_am_delete_linked_vacatures ON public.vacatures;

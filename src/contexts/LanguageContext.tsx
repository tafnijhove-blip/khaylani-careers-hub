...
const translations = {
  nl: {
    ...
    'landing.vacature.badge': 'Vacature Sync',
    ...
    'landing.dashboard.description': 'Zie in één blik welke recruiters draaien, waar je omzet zit en waar je moet bijsturen. No bullshit.',
  ...
  en: {
    ...
    'landing.dashboard.description': 'See at a glance which recruiters are performing, where your revenue is and where you need to adjust. No bullshit.',

...
const LandingMapWithData = () => {
  ...
  const bedrijven: Bedrijf[] = useMemo(() => [
  ...
  const vacatures: Vacature[] = useMemo(() => [
  ...
  const vacatureStats: VacatureStat[] = useMemo(() => [
  ...
  const handleVacatureClick = useCallback((v: Vacature) => {
  ...
  return (
    <div className="relative">
      <MapView
        ...
        onVacatureClick={handleVacatureClick}
      />
